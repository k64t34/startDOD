...
namespace startDOD
{
    public partial class Form1 : Form
    {
        ...
        private void GetTheThreadStarted() {
            ...
            this.textBox_Console.BeginInvoke(DelUpdateUITextBox,"sdgfsdfsg");
            s("sssssssssss");
        }
        public void UpdateUITextBox(String Text) {

            this.textBox_Console.AppendText(Text);
        }
        private void s(string text) 
        {
            this.textBox_Console.BeginInvoke(DelUpdateUITextBox, text);
        }
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //AppendText = this.textBox_Console.AppendText;
            //CheckForIllegalCrossThreadCalls = false;
            //#region
            //new Thread(() =>
            //{
            //    //textBox_Console.AppendText("1");
            //    Action action = () =>
            //      {
            //          textBox_Console.AppendText("123");
            //      };
            //    if (InvokeRequired)
            //        Invoke(action);
            //    else
